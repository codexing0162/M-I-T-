...
class _RegisterFormState extends State<RegisterForm> {
  ...
  Future<void> _fetchCourseNames() async {
    final url = Uri.parse(
      'https://script.google.com/macros/s/AKfycbyte6zpZdIIGozzKg2ASUWVrg3mpcc5BsXZ3KIh0wel23dLBMWunayiMN80SG-h_Pvn/exec', // Replace with your deployment URL
    );
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        throw Exception('Failed to fetch course names');
      }
    } catch (e) {
    ...
    try {
      ...
      if (responseBody['status'] == 'success') {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('Failed to submit data: ${responseBody['message']}'),
          ),
        );
      }
    } catch (e) {
